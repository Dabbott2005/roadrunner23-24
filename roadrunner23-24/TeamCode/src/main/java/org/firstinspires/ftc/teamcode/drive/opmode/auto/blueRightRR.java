...
public class blueRightRR extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence traj_right = drive.trajectorySequenceBuilder(startPose)
                ...
                .forward(50)
                .lineToSplineHeading(new Pose2d(-44,16,(Math.toRadians(90))))
                .waitSeconds(2)
                ...
                .forward(80)
                .lineToSplineHeading(new Pose2d(43,29,(Math.toRadians(0))))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
        ...
        TrajectorySequence traj_middle = drive.trajectorySequenceBuilder(startPose)
                ...
                .forward(50)
                .lineToSplineHeading(new Pose2d(-38,16,(Math.toRadians(90))))
                .waitSeconds(2)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    lift.leftServo.setPosition(LEFT_OPEN);
                })
        ...
        TrajectorySequence traj_left = drive.trajectorySequenceBuilder(startPose)
                ...
                .forward(2)
                .strafeRight(2)
                .lineToSplineHeading(new Pose2d(-34,32,(Math.toRadians(0))))
                .waitSeconds(2)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    lift.leftServo.setPosition(LEFT_OPEN);
                })
